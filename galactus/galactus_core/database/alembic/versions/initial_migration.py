"""Initial migration for Galactus database.
...
def upgrade() -> None:
    ...
    op.create_table('task_templates',
        ...
        sa.Column('metadata', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('is_active', sa.Boolean(), server_default=sa.text('true'), nullable=False),
        sa.Column('version', sa.String(length=50), server_default='1.0.0', nullable=False),
        sa.Column('status', sa.String(length=20), server_default='active', nullable=False),
        sa.Column('input_schema', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('output_schema', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('parameter_schema', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('required_device_types', postgresql.JSON(asdict=True), server_default='[]', nullable=False),
        sa.Column('preferred_device_types', postgresql.JSON(asdict=True), server_default='[]', nullable=False),
        sa.Column('estimated_duration', sa.Integer(), nullable=True),
        sa.Column('max_retries', sa.Integer(), server_default='3', nullable=False),
        sa.Column('retry_delay', sa.Integer(), server_default='60', nullable=False),
        sa.Column('timeout', sa.Integer(), nullable=True),
        sa.Column('requires_user_input', sa.Boolean(), server_default=sa.text('false'), nullable=False),
    ...
    op.create_index(op.f('ix_task_templates_status'), 'task_templates', ['status'], unique=False)
    ...
    op.create_table('device_types',
        ...
        sa.Column('protocol_config_schema', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('capabilities', postgresql.JSON(asdict=True), server_default='[]', nullable=False),
        sa.Column('specifications', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
    ...
    op.create_index(op.f('ix_device_types_name'), 'device_types', ['name'], unique=False)
    op.create_index(op.f('ix_device_types_subcategory'), 'device_types', ['subcategory'], unique=False)
    ...
    op.create_table('locations',
        ...
        sa.Column('environmental_conditions', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('safety_requirements', postgresql.JSON(asdict=True), server_default='[]', nullable=False),
        sa.PrimaryKeyConstraint('id'),
    ...
    # Create task_template_device_types association table
    op.create_table('task_template_device_types',
    ...
    op.create_index('ix_task_template_device_types_task_template_id', 'task_template_device_types', ['task_template_id'], unique=False)
    op.create_index('ix_task_template_device_types_device_type_id', 'task_template_device_types', ['device_type_id'], unique=False)
    ...
    op.create_table('workflow_templates',
        ...
        sa.Column('category', sa.String(length=100), nullable=False),
        sa.Column('status', sa.String(length=20), server_default='active', nullable=False),
        sa.Column('task_graph_template', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('default_sample_count', sa.Integer(), server_default='1', nullable=False),
        sa.Column('max_sample_count', sa.Integer(), server_default='100', nullable=False),
        sa.Column('variable_parameters', postgresql.JSON(asdict=True), server_default='[]', nullable=False),
        sa.Column('default_max_concurrent_tasks', sa.Integer(), server_default='5', nullable=False),
        sa.Column('optimization_enabled', sa.Boolean(), server_default=sa.text('false'), nullable=False),
    ...
    op.create_index(op.f('ix_workflow_templates_status'), 'workflow_templates', ['status'], unique=False)
    ...
    op.create_table('workflows',
        ...
        sa.Column('task_graph', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        ...
        sa.Column('start_conditions', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('stop_conditions', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('optimization_targets', postgresql.JSONB(asdict=True), nullable=True),
        sa.Column('progress_percentage', sa.Integer(), server_default='0', nullable=False),
        sa.Column('current_task_count', sa.Integer(), server_default='0', nullable=False),
    ...
    op.create_table('samples',
        ...
        sa.Column('composition', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('properties', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        ...
        sa.Column('status', sa.String(length=50), server_default='initialized', nullable=False),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('jobs',
        ...
        sa.Column('max_concurrent_tasks', sa.Integer(), server_default='5', nullable=False),
        sa.Column('resource_requirements', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        ...
        sa.Column('execution_mode', sa.String(length=50), server_default='normal', nullable=False),
        sa.Column('execution_config', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('results', postgresql.JSONB(asdict=True), nullable=True),
        sa.Column('artifacts', postgresql.JSON(asdict=True), server_default='[]', nullable=False),
        sa.Column('logs', postgresql.JSON(asdict=True), server_default='[]', nullable=False),
    ...
    op.create_table('job_queues',
        ...
        sa.Column('estimated_start', postgresql.TIMESTAMP(timezone=True), nullable=True),
    ...
    op.create_index('ix_job_queues_queue_priority_time', 'job_queues', ['queue_name', 'priority', 'queued_at'], unique=False)
    ...
    op.create_table('tasks',
        ...
        sa.Column('priority', sa.Integer(), server_default='2', nullable=False),
        sa.Column('retry_count', sa.Integer(), server_default='0', nullable=False),
        sa.Column('inputs', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        ...
        sa.Column('prev_tasks', postgresql.JSON(asdict=True), server_default='[]', nullable=False),
        sa.Column('next_tasks', postgresql.JSON(asdict=True), server_default='[]', nullable=False),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('devices',
        ...
        sa.Column('total_runtime_seconds', sa.Integer(), server_default='0', nullable=False),
        sa.Column('config', postgresql.JSONB(asdict=True), server_default='{}', nullable=False),
        sa.Column('calibration_data', postgresql.JSONB(asdict=True), nullable=True),
        sa.Column('sample_positions', postgresql.JSON(asdict=True), server_default='[]', nullable=False),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['current_task_id'], ['tasks.id'], ),
        sa.ForeignKeyConstraint(['device_type_id'], ['device_types.id'], ),
    ...
    # Create kafka_events table (TimescaleDB hypertable)
    op.create_table('kafka_events',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.Column('name', sa.String(length=255), nullable=False),
    ...
    op.create_index('ix_kafka_events_time_type', 'kafka_events', ['created_at', 'event_type'], unique=False)
    op.create_index('ix_kafka_events_entity', 'kafka_events', ['entity_id', 'entity_type'], unique=False)
    op.create_index(op.f('ix_kafka_events_event_type'), 'kafka_events', ['event_type'], unique=False)

    # Convert kafka_events to TimescaleDB hypertable
    op.execute("SELECT create_hypertable('kafka_events', 'created_at', if_not_exists => TRUE)")
