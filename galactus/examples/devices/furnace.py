"""
Example furnace device implementation for Galactus.
"""
...
from galactus_core.models.device import Device, DeviceStatus, DeviceCapability
from galactus_core.models.base import BaseDBModel
...
class Furnace(Device):
    ...
    def set_temperature(self, temperature: float, rate: Optional[float] = None):
        ...
        # Emit event
        from galactus_core.events.producer import event_producer
